...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERACCOUNT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERACCOUNT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERACCOUNT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERACCOUNT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERACCOUNT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERACCOUNT actions', async () => {
      const arg = 42666;
