          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('activityMultiplier')}>
                  Activity Multiplier <FontAwesomeIcon icon={getSortIconByFieldName('activityMultiplier')} />
                </th>
                <th>
                  Activity Log <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {activityList.map((activity, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{activity.activityMultiplier}</td>
                  <td>
                    {activity.activityLog ? <Link to={`/activity-log/${activity.activityLog.id}`}>{activity.activityLog.id}</Link> : ''}
                  </td>
