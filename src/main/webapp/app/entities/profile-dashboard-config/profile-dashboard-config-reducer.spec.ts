...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './profile-dashboard-config.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROFILEDASHBOARDCONFIG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROFILEDASHBOARDCONFIG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROFILEDASHBOARDCONFIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROFILEDASHBOARDCONFIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROFILEDASHBOARDCONFIG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROFILEDASHBOARDCONFIG actions', async () => {
      const arg = 42666;
