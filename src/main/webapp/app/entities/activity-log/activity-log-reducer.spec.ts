...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIVITYLOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACTIVITYLOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACTIVITYLOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ACTIVITYLOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVITYLOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACTIVITYLOG actions', async () => {
      const arg = 42666;
