...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BODYHEIGHT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BODYHEIGHT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BODYHEIGHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BODYHEIGHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BODYHEIGHT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BODYHEIGHT actions', async () => {
      const arg = 42666;
