...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BLOODGLUCOSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BLOODGLUCOSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BLOODGLUCOSE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BLOODGLUCOSE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BLOODGLUCOSE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BLOODGLUCOSE actions', async () => {
      const arg = 42666;
