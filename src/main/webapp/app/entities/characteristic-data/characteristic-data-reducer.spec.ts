...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './characteristic-data.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHARACTERISTICDATA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHARACTERISTICDATA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHARACTERISTICDATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHARACTERISTICDATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHARACTERISTICDATA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHARACTERISTICDATA actions', async () => {
      const arg = 42666;
