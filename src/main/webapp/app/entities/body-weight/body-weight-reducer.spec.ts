...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BODYWEIGHT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BODYWEIGHT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BODYWEIGHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BODYWEIGHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BODYWEIGHT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BODYWEIGHT actions', async () => {
      const arg = 42666;
