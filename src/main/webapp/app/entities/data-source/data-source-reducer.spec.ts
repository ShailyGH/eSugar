...
import { IDataSource, defaultValue } from 'app/shared/model/data-source.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DATASOURCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches CREATE_DATASOURCE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DATASOURCE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DATASOURCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DATASOURCE actions', async () => {
      const arg = 42666;
