...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './user-bmr.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERBMR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERBMR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERBMR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERBMR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERBMR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERBMR actions', async () => {
      const arg = 42666;
