...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BODYVITALSLOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BODYVITALSLOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BODYVITALSLOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BODYVITALSLOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BODYVITALSLOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BODYVITALSLOG actions', async () => {
      const arg = 42666;
