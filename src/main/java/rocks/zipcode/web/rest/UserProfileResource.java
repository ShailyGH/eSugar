    ...
    public ResponseEntity<UserProfile> partialUpdateUserProfile(
        ...
        Optional<UserProfile> result = userProfileRepository
            ...
            .map(existingUserProfile -> {
                if (userProfile.getUserProfileName() != null) {
                    existingUserProfile.setUserProfileName(userProfile.getUserProfileName());
                }
                if (userProfile.getEmail() != null) {
                    existingUserProfile.setEmail(userProfile.getEmail());
                }
                if (userProfile.getIsReportSharingEnabled() != null) {
                    existingUserProfile.setIsReportSharingEnabled(userProfile.getIsReportSharingEnabled());
                }
                if (userProfile.getIsActive() != null) {
                    existingUserProfile.setIsActive(userProfile.getIsActive());
                }
